...
.method public flagActionItems()Z
    ...
    iget v2, v0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMinCellSize:I
    ...
    .line 473
    invoke-virtual {v0, v15, v3, v7}, Landroidx/appcompat/widget/ActionMenuPresenter;->getItemView(Landroidx/appcompat/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v3, v13, v14, v6, v8}, Landroidx/appcompat/widget/ActionMenuView;->measureChildForCells(Landroid/view/View;IIII)I
    ...
    :goto_5
    invoke-virtual {v15, v5}, Landroidx/appcompat/view/menu/MenuItemImpl;->setIsActionButton(Z)V
    ...
    .local v8, "requiredItems":I
    .restart local v15    # "item":Landroidx/appcompat/view/menu/MenuItemImpl;
    :cond_b
    move/from16 v19, v8
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    iput v3, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mOpenSubMenuId:I
    ...
    .line 301
    invoke-virtual {p1, v1}, Landroidx/appcompat/view/menu/SubMenuBuilder;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, v5, p1, v2}, Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Landroidx/appcompat/view/menu/SubMenuBuilder;Landroid/view/View;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mActionButtonPopup:Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;
    ...
    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;->setForceShowIcon(Z)V

    .line 310
    iget-object v1, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mActionButtonPopup:Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;

    invoke-virtual {v1}, Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;->show()V
...
.method public updateMenuView(Z)V
    ...
    invoke-virtual {v4}, Landroidx/appcompat/view/menu/MenuItemImpl;->getSupportActionProvider()Landroidx/core/view/ActionProvider;

    move-result-object v4

    .line 235
    .local v4, "provider":Landroidx/core/view/ActionProvider;
    if-eqz v4, :cond_0

    .line 236
    invoke-virtual {v4, p0}, Landroidx/core/view/ActionProvider;->setSubUiVisibilityListener(Landroidx/core/view/ActionProvider$SubUiVisibilityListener;)V

    .line 233
    .end local v4    # "provider":Landroidx/core/view/ActionProvider;
    :cond_0
    add-int/lit8 v3, v3, 0x1
    ...
    invoke-direct {v1, p0, v3}, Landroidx/appcompat/widget/ActionMenuPresenter$OverflowMenuButton;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, Landroidx/appcompat/widget/ActionMenuPresenter$OverflowMenuButton;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/ActionMenuView;->setOverflowReserved(Z)V
