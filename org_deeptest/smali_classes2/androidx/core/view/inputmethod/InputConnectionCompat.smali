...
.method static handlePerformPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;Landroidx/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Z
    ...
    .line 99
    .local v8, "linkUri":Landroid/net/Uri;
    if-eqz v1, :cond_6
    ...
    .line 105
    .local v10, "opts":Landroid/os/Bundle;
    if-eqz v6, :cond_8
    ...
    invoke-direct {v11, v6, v7, v8}, Landroidx/core/view/inputmethod/InputContentInfoCompat;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V

    .line 108
    .local v11, "inputContentInfo":Landroidx/core/view/inputmethod/InputContentInfoCompat;
    invoke-interface {p2, v11, v9, v10}, Landroidx/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;->onCommitContent(Landroidx/core/view/inputmethod/InputContentInfoCompat;ILandroid/os/Bundle;)Z
    ...
    .end local v8    # "linkUri":Landroid/net/Uri;
    .end local v9    # "flags":I
    .end local v10    # "opts":Landroid/os/Bundle;
    .end local v11    # "inputContentInfo":Landroidx/core/view/inputmethod/InputContentInfoCompat;
    :cond_8
    if-eqz v2, :cond_a
