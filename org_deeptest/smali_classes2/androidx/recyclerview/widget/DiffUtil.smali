...
.method public static calculateDiff(Landroidx/recyclerview/widget/DiffUtil$Callback;Z)Landroidx/recyclerview/widget/DiffUtil$DiffResult;
    ...
    .local v3, "rangePool":Ljava/util/List;, "Ljava/util/List<Landroidx/recyclerview/widget/DiffUtil$Range;>;"
    :goto_0
    move-object v6, v3

    .line 143
    .end local v3    # "rangePool":Ljava/util/List;, "Ljava/util/List<Landroidx/recyclerview/widget/DiffUtil$Range;>;"
...
.method private static diffPartial(Landroidx/recyclerview/widget/DiffUtil$Callback;IIII[I[II)Landroidx/recyclerview/widget/DiffUtil$Snake;
    ...
    .line 233
    invoke-virtual {v0, v6, v7}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    iput v7, v6, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I
    ...
    iput v7, v6, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I
    ...
    iput v7, v6, Landroidx/recyclerview/widget/DiffUtil$Snake;->size:I

    .line 244
    iput-boolean v9, v6, Landroidx/recyclerview/widget/DiffUtil$Snake;->removal:Z

    .line 245
    const/4 v7, 0x0

    iput-boolean v7, v6, Landroidx/recyclerview/widget/DiffUtil$Snake;->reverse:Z
    ...
    .line 268
    invoke-virtual {v0, v7, v1}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    .line 276
    .local v1, "outSnake":Landroidx/recyclerview/widget/DiffUtil$Snake;
    add-int v7, p7, v3

    aget v7, v5, v7

    iput v7, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    .line 277
    iget v7, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->x:I

    sub-int/2addr v7, v3

    iput v7, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->y:I
    ...
    iput v7, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->size:I

    .line 280
    iput-boolean v9, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->removal:Z

    .line 281
    const/4 v7, 0x1

    iput-boolean v7, v1, Landroidx/recyclerview/widget/DiffUtil$Snake;->reverse:Z

    .line 282
    return-object v1

    .line 250
    .end local v1    # "outSnake":Landroidx/recyclerview/widget/DiffUtil$Snake;
