...
.method private handleLoginMessage(Landroid/os/Message;Ljava/lang/String;Lcom/heytap/usercenter/accountsdk/http/AccountNameTask$onReqAccountCallback;)V
    ...
    const-string p2, "AccountAgentWrapper please handleLoginMessage set callback"
    ...
    const-string v0, "AccountAgentWrapper handleLoginMessage success"
    ...
    const-string p2, "AccountAgentWrapper handleLoginMessage failure"
...
.method private handleUserInfo(Lcom/platform/usercenter/basic/core/mvvm/Resource;Lcom/heytap/usercenter/accountsdk/model/IpcAccountEntity;Lcom/heytap/usercenter/accountsdk/http/AccountNameTask$onReqAccountCallback;)V
    ...
    const-string v3, "AccountAgentWrapper handleUserInfo account isLogin = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, p1, Lcom/platform/usercenter/basic/core/mvvm/Resource;->data:Ljava/lang/Object;
    ...
    iget v3, p1, Lcom/platform/usercenter/basic/core/mvvm/Resource;->code:I
    ...
    .line 32
    iput-boolean v4, p1, Lcom/heytap/usercenter/accountsdk/model/SignInAccount;->isLogin:Z
...
.method private realReqToken(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;)V
    ...
    const-string v1, "AccountAgentWrapper reqToken isSingleUserVersion"
    ...
    const-string p3, "AccountAgentWrapper reqToken isSingleUserVersion isNotLogged ActivityNotFoundException"

    .line 18
    invoke-static {p1, p3}, Lcom/platform/usercenter/tools/log/UCLogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, p3, v0, v1, v2}, Lcom/nearme/aidl/UserEntity;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "AccountAgentWrapper reqToken isNotSingleUserVersion"
...
.method private sendUserMessage(Landroid/os/Handler;Lcom/nearme/aidl/UserEntity;)V
    ...
    const-string p2, "AccountAgentWrapper sendUserMessage handler = null "
...
.method public getAccountEntity(Landroid/content/Context;Ljava/lang/String;)Lcom/heytap/usercenter/accountsdk/model/AccountEntity;
    ...
    .line 16
    sget-object p2, Lcom/accountbase/u;->a:Ljava/lang/String;

    invoke-static {p2}, Lcom/platform/usercenter/tools/io/FileUtils;->readStringFromFile(Ljava/lang/String;)Ljava/lang/String;
...
.method public getAccountResult(Landroid/content/Context;Ljava/lang/String;)Lcom/heytap/usercenter/accountsdk/AccountResult;
    ...
    .line 17
    :cond_0
    invoke-virtual {p2, v3}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setCanJump2Bind(Z)V

    .line 18
    invoke-virtual {p2, v2}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setOldUserName(Ljava/lang/String;)V

    .line 19
    invoke-virtual {p2, v1}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setResultCode(I)V

    const-string p1, "usercenter has none account"
    ...
    .line 25
    new-instance v4, Lcom/heytap/usercenter/accountsdk/AccountResult;

    invoke-direct {v4}, Lcom/heytap/usercenter/accountsdk/AccountResult;-><init>()V

    .line 26
    invoke-virtual {v4, v3}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setCanJump2Bind(Z)V

    if-nez v0, :cond_2

    .line 28
    invoke-virtual {v4, v2}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setOldUserName(Ljava/lang/String;)V

    .line 29
    invoke-virtual {v4, v1}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setResultCode(I)V

    const-string p1, "usercenter has none account"

    .line 30
    invoke-virtual {v4, p1}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setResultMsg(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, p1}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setOldUserName(Ljava/lang/String;)V

    const p1, 0x1c9cf65

    .line 34
    invoke-virtual {v4, p1}, Lcom/heytap/usercenter/accountsdk/AccountResult;->setResultCode(I)V
...
.method public getSignInAccount(Landroid/content/Context;Ljava/lang/String;Lcom/heytap/usercenter/accountsdk/http/AccountNameTask$onReqAccountCallback;)V
    ...
    invoke-virtual {v0}, Lcom/heytap/usercenter/accountsdk/AccountAgentClient;->getConfig()Lcom/heytap/usercenter/accountsdk/AccountSDKConfig;

    move-result-object v0

    iget-object v0, v0, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig;->mExtension:Lcom/heytap/usercenter/accountsdk/AcExtension;

    invoke-interface {v0}, Lcom/heytap/usercenter/accountsdk/AcExtension;->isForeground()Z
    ...
    const-string v1, "AccountAgentWrapper getSignInAccount is foreground "
    ...
    .line 10
    new-instance v6, Lcom/heytap/usercenter/accountsdk/AccountAgentWrapper$b;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/heytap/usercenter/accountsdk/AccountAgentWrapper$b;-><init>(Lcom/heytap/usercenter/accountsdk/AccountAgentWrapper;Ljava/lang/String;Lcom/heytap/usercenter/accountsdk/http/IAsyncTaskExecutor;Lcom/heytap/usercenter/accountsdk/http/AccountNameTask$onReqAccountCallback;Z)V

    invoke-interface {p1, v6}, Lcom/heytap/usercenter/accountsdk/http/IAsyncTaskExecutor;->runOnAsyncExecutor(Ljava/lang/Runnable;)V
...
.method public reqReSignin(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;)V
    ...
    const-string v1, "AccountAgentWrapper reqReSignin isSingleUserVersion"
    ...
    const-string p3, "AccountAgentWrapper reqReSignin isSingleUserVersion ActivityNotFoundException"
    ...
    const-string v1, "AccountAgentWrapper reqReSignin isNotSingleUserVersion"
