...
.method public constructor <init>(Lcom/oplus/anim/model/content/MergePaths;)V
    .locals 2
    .param p1, "mergePaths"    # Lcom/oplus/anim/model/content/MergePaths;
...
.method private opFirstPathWithRest(Landroid/graphics/Path$Op;)V
    ...
    .line 101
    .local v2, "content":Lcom/oplus/anim/animation/content/PathContent;
    ...
    invoke-virtual {v3}, Lcom/oplus/anim/animation/content/ContentGroup;->getPathList()Ljava/util/List;

    move-result-object v3

    .line 103
    .local v3, "pathList":Ljava/util/List;, "Ljava/util/List<Lcom/oplus/anim/animation/content/PathContent;>;"
    ...
    check-cast v6, Lcom/oplus/anim/animation/content/ContentGroup;

    invoke-virtual {v6}, Lcom/oplus/anim/animation/content/ContentGroup;->getTransformationMatrix()Landroid/graphics/Matrix;
    ...
    .line 108
    .end local v3    # "pathList":Ljava/util/List;, "Ljava/util/List<Lcom/oplus/anim/animation/content/PathContent;>;"
    .end local v4    # "j":I
    :cond_0
    goto :goto_2
    ...
    .line 98
    .end local v2    # "content":Lcom/oplus/anim/animation/content/PathContent;
    :goto_2
    add-int/lit8 v0, v0, -0x1
    ...
    .line 114
    .local v0, "lastContent":Lcom/oplus/anim/animation/content/PathContent;
    ...
    .line 116
    .local v2, "pathList":Ljava/util/List;, "Ljava/util/List<Lcom/oplus/anim/animation/content/PathContent;>;"
    nop
    ...
    check-cast v4, Lcom/oplus/anim/animation/content/ContentGroup;

    invoke-virtual {v4}, Lcom/oplus/anim/animation/content/ContentGroup;->getTransformationMatrix()Landroid/graphics/Matrix;
    ...
    .line 121
    .end local v1    # "j":I
    .end local v2    # "pathList":Ljava/util/List;, "Ljava/util/List<Lcom/oplus/anim/animation/content/PathContent;>;"
    :cond_3
    goto :goto_4
    ...
    iget-object v2, p0, Lcom/oplus/anim/animation/content/MergePathsContent;->firstPath:Landroid/graphics/Path;
...
.method public absorbContent(Ljava/util/ListIterator;)V
    ...
    .line 35
    .local p1, "contents":Ljava/util/ListIterator;, "Ljava/util/ListIterator<Lcom/oplus/anim/animation/content/Content;>;"
    :goto_0
    ...
    .line 39
    .local v0, "content":Lcom/oplus/anim/animation/content/Content;
    ...
    .line 43
    .end local v0    # "content":Lcom/oplus/anim/animation/content/Content;
    :cond_1
    goto :goto_1
...
.method public getName()Ljava/lang/String;
    ...
    .line 84
    iget-object v0, p0, Lcom/oplus/anim/animation/content/MergePathsContent;->name:Ljava/lang/String;
...
.method public setContents(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {v1, p1, p2}, Lcom/oplus/anim/animation/content/PathContent;->setContents(Ljava/util/List;Ljava/util/List;)V
