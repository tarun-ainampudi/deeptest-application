...
.method private addOpacityStopsToGradientIfNeeded(Lcom/oplus/anim/model/content/GradientColor;Ljava/util/List;)V
    .locals 10
    .param p1, "gradientColor"    # Lcom/oplus/anim/model/content/GradientColor;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/oplus/anim/model/content/GradientColor;",
    ...
    invoke-direct {p0, v6, v7, v2, v3}, Lcom/oplus/anim/parser/GradientColorParser;->getOpacityAtPosition(D[D[D)I
...
.method private getOpacityAtPosition(D[D[D)I
    ...
    invoke-static/range {v15 .. v20}, Lcom/oplus/anim/utils/MiscUtils;->lerp(DDD)D

    move-result-wide v13

    mul-double v4, v13, v5
...
# virtual methods
.method public parse(Landroid/util/JsonReader;F)Lcom/oplus/anim/model/content/GradientColor;
    .locals 13
    ...
    .line 62
    :cond_3
    iget v2, p0, Lcom/oplus/anim/parser/GradientColorParser;->colorPoints:I
    ...
    iput v2, p0, Lcom/oplus/anim/parser/GradientColorParser;->colorPoints:I
    ...
    iget v4, p0, Lcom/oplus/anim/parser/GradientColorParser;->colorPoints:I
    ...
    .local v3, "i":I
    :goto_2
    iget v7, p0, Lcom/oplus/anim/parser/GradientColorParser;->colorPoints:I
    ...
    .end local v3    # "i":I
    :cond_5
    new-instance v3, Lcom/oplus/anim/model/content/GradientColor;

    invoke-direct {v3, v2, v4}, Lcom/oplus/anim/model/content/GradientColor;-><init>([F[I)V

    .line 93
    .local v3, "gradientColor":Lcom/oplus/anim/model/content/GradientColor;
    invoke-direct {p0, v3, v0}, Lcom/oplus/anim/parser/GradientColorParser;->addOpacityStopsToGradientIfNeeded(Lcom/oplus/anim/model/content/GradientColor;Ljava/util/List;)V
...
.method public bridge synthetic parse(Landroid/util/JsonReader;F)Ljava/lang/Object;
    ...
    .line 16
    invoke-virtual {p0, p1, p2}, Lcom/oplus/anim/parser/GradientColorParser;->parse(Landroid/util/JsonReader;F)Lcom/oplus/anim/model/content/GradientColor;
