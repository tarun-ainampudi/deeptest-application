...
.method static parse(Landroid/util/JsonReader;Lcom/oplus/anim/EffectiveAnimationComposition;FLcom/oplus/anim/parser/ValueParser;Z)Lcom/oplus/anim/value/Keyframe;
    .locals 1
    ...
    .line 58
    invoke-static {p1, p0, p2, p3}, Lcom/oplus/anim/parser/KeyframeParser;->parseKeyframe(Lcom/oplus/anim/EffectiveAnimationComposition;Landroid/util/JsonReader;FLcom/oplus/anim/parser/ValueParser;)Lcom/oplus/anim/value/Keyframe;
    ...
    .line 60
    :cond_0
    invoke-static {p0, p2, p3}, Lcom/oplus/anim/parser/KeyframeParser;->parseStaticValue(Landroid/util/JsonReader;FLcom/oplus/anim/parser/ValueParser;)Lcom/oplus/anim/value/Keyframe;
...
.method private static parseKeyframe(Lcom/oplus/anim/EffectiveAnimationComposition;Landroid/util/JsonReader;FLcom/oplus/anim/parser/ValueParser;)Lcom/oplus/anim/value/Keyframe;
    .locals 19
    ...
    .line 113
    :pswitch_0
    invoke-static/range {p1 .. p2}, Lcom/oplus/anim/parser/JsonUtils;->jsonToPoint(Landroid/util/JsonReader;F)Landroid/graphics/PointF;
    ...
    :pswitch_5
    invoke-interface {v3, v1, v2}, Lcom/oplus/anim/parser/ValueParser;->parse(Landroid/util/JsonReader;F)Ljava/lang/Object;
    ...
    .end local v7    # "endValue":Ljava/lang/Object;, "TT;"
    .local v0, "endValue":Ljava/lang/Object;, "TT;"
    sget-object v7, Lcom/oplus/anim/parser/KeyframeParser;->LINEAR_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    invoke-static {v0, v10, v2}, Lcom/oplus/anim/utils/MiscUtils;->clamp(FFF)F
    ...
    invoke-static {v0, v11, v10}, Lcom/oplus/anim/utils/MiscUtils;->clamp(FFF)F
    ...
    invoke-static {v0, v12, v2}, Lcom/oplus/anim/utils/MiscUtils;->clamp(FFF)F
    ...
    invoke-static {v0, v10, v11, v12}, Lcom/oplus/anim/utils/Utils;->hashFor(FFFF)I

    move-result v10

    .line 131
    .local v10, "hash":I
    invoke-static {v10}, Lcom/oplus/anim/parser/KeyframeParser;->getInterpolator(I)Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v10, v0}, Lcom/oplus/anim/parser/KeyframeParser;->putInterpolator(ILjava/lang/ref/WeakReference;)V
    :try_end_0
    ...
    invoke-direct/range {v10 .. v16}, Lcom/oplus/anim/value/Keyframe;-><init>(Lcom/oplus/anim/EffectiveAnimationComposition;Ljava/lang/Object;Ljava/lang/Object;Landroid/view/animation/Interpolator;FLjava/lang/Float;)V

    .line 153
    .local v1, "keyframe":Lcom/oplus/anim/value/Keyframe;, "Lcom/oplus/anim/value/Keyframe<TT;>;"
    iput-object v2, v1, Lcom/oplus/anim/value/Keyframe;->pathCp1:Landroid/graphics/PointF;

    .line 154
    iput-object v9, v1, Lcom/oplus/anim/value/Keyframe;->pathCp2:Landroid/graphics/PointF;
...
.method private static parseStaticValue(Landroid/util/JsonReader;FLcom/oplus/anim/parser/ValueParser;)Lcom/oplus/anim/value/Keyframe;
    .locals 2
    .param p0, "reader"    # Landroid/util/JsonReader;
    .param p1, "scale"    # F
    .annotation system Ldalvik/annotation/Signature;
    ...
    invoke-interface {p2, p0, p1}, Lcom/oplus/anim/parser/ValueParser;->parse(Landroid/util/JsonReader;F)Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lcom/oplus/anim/value/Keyframe;-><init>(Ljava/lang/Object;)V
