...
# virtual methods
.method public parse(Landroid/util/JsonReader;F)Lcom/oplus/anim/model/content/ShapeData;
    .locals 16
    ...
    .line 48
    :pswitch_0
    invoke-static/range {p1 .. p2}, Lcom/oplus/anim/parser/JsonUtils;->jsonToPoints(Landroid/util/JsonReader;F)Ljava/util/List;
    ...
    .line 64
    new-instance v4, Lcom/oplus/anim/model/content/ShapeData;
    ...
    invoke-direct {v4, v6, v5, v7}, Lcom/oplus/anim/model/content/ShapeData;-><init>(Landroid/graphics/PointF;ZLjava/util/List;)V
    ...
    .line 72
    .local v9, "curves":Ljava/util/List;, "Ljava/util/List<Lcom/oplus/anim/model/CubicCurveData;>;"
    nop
    ...
    invoke-static {v10, v11}, Lcom/oplus/anim/utils/MiscUtils;->addPoints(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v13

    .line 78
    .local v13, "shapeCp1":Landroid/graphics/PointF;
    invoke-static {v7, v12}, Lcom/oplus/anim/utils/MiscUtils;->addPoints(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v14

    .line 79
    .local v14, "shapeCp2":Landroid/graphics/PointF;
    new-instance v15, Lcom/oplus/anim/model/CubicCurveData;

    invoke-direct {v15, v13, v14, v7}, Lcom/oplus/anim/model/CubicCurveData;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    invoke-static {v6, v10}, Lcom/oplus/anim/utils/MiscUtils;->addPoints(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v11

    .line 89
    .local v11, "shapeCp1":Landroid/graphics/PointF;
    invoke-static {v7, v5}, Lcom/oplus/anim/utils/MiscUtils;->addPoints(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v12

    .line 91
    .local v12, "shapeCp2":Landroid/graphics/PointF;
    new-instance v13, Lcom/oplus/anim/model/CubicCurveData;

    invoke-direct {v13, v11, v12, v7}, Lcom/oplus/anim/model/CubicCurveData;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    :cond_a
    new-instance v5, Lcom/oplus/anim/model/content/ShapeData;

    invoke-direct {v5, v8, v0, v9}, Lcom/oplus/anim/model/content/ShapeData;-><init>(Landroid/graphics/PointF;ZLjava/util/List;)V
    ...
    .end local v9    # "curves":Ljava/util/List;, "Ljava/util/List<Lcom/oplus/anim/model/CubicCurveData;>;"
    :cond_b
...
.method public bridge synthetic parse(Landroid/util/JsonReader;F)Ljava/lang/Object;
    ...
    .line 16
    invoke-virtual {p0, p1, p2}, Lcom/oplus/anim/parser/ShapeDataParser;->parse(Landroid/util/JsonReader;F)Lcom/oplus/anim/model/content/ShapeData;
