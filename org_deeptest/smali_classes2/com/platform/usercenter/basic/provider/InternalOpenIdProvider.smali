...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 22
    .local p0, "this":Lcom/platform/usercenter/basic/provider/InternalOpenIdProvider;, "Lcom/platform/usercenter/basic/provider/InternalOpenIdProvider<TT;>;"
...
.method public create()Lcom/platform/usercenter/basic/provider/OpenIdBean;
    ...
    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->init(Landroid/content/Context;)V
    ...
    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->getGUID(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->getOUID(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    .line 45
    .local v4, "ouid":Ljava/lang/String;
    iget-object v1, p0, Lcom/platform/usercenter/basic/provider/InternalOpenIdProvider;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->getDUID(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v5

    .line 47
    .local v5, "duid":Ljava/lang/String;
    iget-object v1, p0, Lcom/platform/usercenter/basic/provider/InternalOpenIdProvider;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->getAUID(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->getAPID(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v7

    .line 51
    .local v7, "apid":Ljava/lang/String;
    iget-object v1, p0, Lcom/platform/usercenter/basic/provider/InternalOpenIdProvider;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/oplus/stdid/sdk/StdIDSDK;->clear(Landroid/content/Context;)V
    ...
    .end local v4    # "ouid":Ljava/lang/String;
    .end local v5    # "duid":Ljava/lang/String;
    .end local v6    # "auid":Ljava/lang/String;
    .end local v7    # "apid":Ljava/lang/String;
    :catch_0
    move-exception v1
