...
.method public constructor <init>(Lcom/platform/usercenter/network/NetworkModule$Builder;)V
    .locals 1
    .param p1, "builder"    # Lcom/platform/usercenter/network/NetworkModule$Builder;
...
.method private getHeaderInterceptor()Lcom/platform/usercenter/network/interceptor/HeaderInterceptor;
    ...
    .line 181
    .local v0, "headerManager":Lcom/platform/usercenter/network/header/IBizHeaderManager;
    :goto_0
...
.method private provideNormalRetrofitBuilder(Lcom/google/gson/Gson;)Lretrofit2/Retrofit$Builder;
    .locals 3
    ...
    invoke-interface {v1}, Lcom/platform/usercenter/network/provider/INetConfigProvider;->getConvertFactory()Lretrofit2/Converter$Factory;
    ...
    iget-object v2, p0, Lcom/platform/usercenter/network/NetworkModule;->mBaseUrl:Ljava/lang/String;
...
.method private setOkHttpClientConfig(Lokhttp3/OkHttpClient$Builder;)V
    ...
    .line 149
    .local v0, "provider":Lcom/platform/usercenter/network/provider/INetConfigProvider;
    ...
    invoke-virtual {v4, v1, v2}, Lokhttp3/OkHttpClient$Builder;->sslSocketFactory(Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/X509TrustManager;)Lokhttp3/OkHttpClient$Builder;
    ...
    .line 146
    .end local v0    # "provider":Lcom/platform/usercenter/network/provider/INetConfigProvider;
    :cond_3
    :goto_0
    return-void
.end method
...
.method public provideNormalOkHttpClient()Lokhttp3/OkHttpClient;
    ...
    iput-object v1, p0, Lcom/platform/usercenter/network/NetworkModule;->mOkHttpClient:Lokhttp3/OkHttpClient;
...
.method public provideNormalRetrofit()Lretrofit2/Retrofit;
    .locals 2

    .line 134
    iget-object v0, p0, Lcom/platform/usercenter/network/NetworkModule;->mRetrofit:Lretrofit2/Retrofit;
    ...
    invoke-direct {p0, v0}, Lcom/platform/usercenter/network/NetworkModule;->provideNormalRetrofitBuilder(Lcom/google/gson/Gson;)Lretrofit2/Retrofit$Builder;
    ...
    iput-object v1, p0, Lcom/platform/usercenter/network/NetworkModule;->mRetrofit:Lretrofit2/Retrofit;
